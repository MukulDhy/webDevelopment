...
// 4:55:07  indexOf();
// 4:55:56  Video stuck from here;
// 5:25:04  Video stuck till here;
...
// 7:18:05 replace(searchFor,replace with) methods ''it returns a new string, it does not edit original string, if does not match it returns full string'';
...
// const arrObj =  Object.entries(person);  /* returns an array */
// console.log(arrObj);   
// console.log(Object.fromEntries(arrObj)); /* But it will return an object  */
...
// const sPerson = { ...person , cName : "MBBs" };
...
/*   Array.prototype.splice(index, how many elements to removes from array , what elements wanted to add or update to array) */

// Adds and/or removes elements from an array.

// 1: Add Dec at the end of an array?
// 2: What is the return value of splice method?   /* How many elements removed? */
